...
def post_vasp(systems, pbe): # natvie python or create job
    set_env(task='eos',pbe=pbe)
    job_with_node(argv_=systems,task='eos', script='mlp.py', job_name='tz', partition='gpu',nodelist='n008',run=True)
...
if __name__ == '__main__':
    ...
    #systems = 'Al Ca Co Cu Fe Hf Ir K Li Mg Mo Na Nb' 
    # systems= 'Ni Os Pd Pt Re Rb Rh Sr'
    systems='Ti Ta V W Zn Zr Cs Cd Y' 
    pbe = sys.argv[1]
